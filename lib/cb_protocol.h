...
enum cs1_safestate_reason {
    ...
    CS1_SAFESTATE_REASON_UNDEFINED_1,
    CS1_SAFESTATE_REASON_RCM_ERROR,
    CS1_SAFESTATE_REASON_RCM_SELFTEST,
...
enum errmsg_module {
    ...
    ERRMSG_MODULE_APP_SAFETY = 3,
    ERRMSG_MODULE_APP_CP_PP = 4,
    ERRMSG_MODULE_APP_TEMP = 5,
    ERRMSG_MODULE_APP_SYSTEM = 6,
